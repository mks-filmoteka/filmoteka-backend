package io.github.mksfilmoteka.backend.common.logging;
...
class RequestLoggingFilterTest {
    ...
    void shouldCreateRequestLogWithPathWithoutQueryString() {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v1/films");
        ...
        assertThat(requestLog.path()).isEqualTo("/api/v1/films");
    ...
    void shouldCreateRequestLogWithPathAndQueryString() {
        ...
        assertThat(requestLog.method()).isEqualTo("GET");
        assertThat(requestLog.path()).isEqualTo("/api/v1/films?page=0&size=100");
        assertThat(requestLog.status()).isEqualTo(200);
        assertThat(requestLog.durationMs()).isEqualTo(100);
    }
}